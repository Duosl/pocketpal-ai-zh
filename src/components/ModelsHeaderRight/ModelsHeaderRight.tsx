...
export const ModelsHeaderRight = observer(() => {
  ...
  // Initialize filters with 'grouped' enabled by default
  const defaultFilters = ['grouped'];
  if (!uiStore.pageStates.modelsScreen.filters) {
    uiStore.setValue('modelsScreen', 'filters', defaultFilters);
  }
